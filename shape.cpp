...
double Shape::getLeftX() const {return 0.0;}
double Shape::getRightX() const {return 0.0;}
double Shape::getTopY() const {return 0.0;}
double Shape::getBottomY() const {return 0.0;}
